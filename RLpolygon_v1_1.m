...
Er=3.55;            %[-] relative permittivity of dielectric substrate (For RO4003C, we use 3.55) SUBJECT TO CHANGE
Eprop = 2.8;     % propagation permittivity used ONLY for spacing/scale
                 % (microstrip ~2.7–2.9; stripline use 3.55; GCPW ~3.0)
...
f1=5*lambda0;   %On-axis focal length (MAY NEED 3-4lambda0 at 60 GHz) 
...
Lw=lambda0;         %[m]length of the transmission lines (TL) MAY NEED 0.5*Lambda

Lbp=3*lambda0;  %[m]length of taper transition from RL region to TL at BEAM ports (MAY NEED TO REDUCE 3 to 1)
